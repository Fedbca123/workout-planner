...
export default function CreateWorkout({ navigation, route }) {
    ...
    return (
        <View style={{flex: 1}}>
            ...
            {currState === "BeginFinalizing" && <BeginFinalizeWorkout workout={currWorkout} updateWorkout={setCurrWorkout} setCurrState={setCurrState} modifyScheduledWorkout={route.params && route.params.modifyScheduledWorkout ? route.params.modifyScheduledWorkout : false} theme={globalState.theme}/>}
            {currState === "Schedule" && <ScheduleWorkout workout={currWorkout} updateWorkout={setCurrWorkout} setCurrState={setCurrState} modifyScheduledWorkout={route.params && route.params.modifyScheduledWorkout ? route.params.modifyScheduledWorkout : false} theme={globalState.theme}/>}
